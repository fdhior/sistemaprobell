...
<table class="visitastabla" align="center" border="1" cellpadding="0" cellspacing="0">
  ...
  <tr align="left" valign="top">
    <td><iframe class="visitmarco" name="visitlist" title="visitlist" marginheight="0" marginwidth="0" id="visitlist" src="sistemas/soporte/visitas/visitas_lista.php" hspace="0" frameborder="0" align="top" scrolling="yes"></iframe></td>
  </tr>
  <tr>
  ...
  <tr>
    <td><table class="visitasdettabla" width="100%" border="1" cellspacing="0" cellpadding="0">
      <tr>
        <th width="80%" scope="col"><iframe name="visitdet" title="visitdet" class="visitdetmarco"  marginheight="0" marginwidth="0" id="visitdet" <?php
					$relative_path = "sistemas/soporte/visitas";
					if (isset($_SESSION['idvisit'])) {
						$idvisit = $_SESSION['idvisit'];
						echo "src=\"$relative_path/visitas_detalle.php?idv=$idvisit\"";
						unset($_SESSION['idvisit']);
					} else if (isset($_SESSION['muestradet'])) {
						switch ($_SESSION['muestradet']) {
							case "repvisit":
								echo "src=\"$relative_path/visitas_reporte.php\"";
								break;
						}
						unset($_SESSION['muestradet']);
					} else {	
						echo "src=\"$relative_path/visitas_detalle_ult3.php\"";
					}	
