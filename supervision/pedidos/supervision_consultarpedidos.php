...
<div id="apDiv1"><span class="letra_predeterminada">Ordenar Lista</span>
      ...
      <tr>
        ...
        <form id="form4" name="form4" method="post" action="<?php echo $target_link; ?>" target="<?php echo $target_frame; ?>">
          <td><div align="center">
              ...
              <input class="letra_boton11" type="submit" name="button" id="button" value="Por Destino" />
          </div></td>
        </form>
     </tr>
      <tr>
        <form id="form5" name="form5" method="post" action="<?php echo $target_link; ?>" target="<?php echo $target_frame; ?>">
          <td><div align="center">
            ...
            <input class="letra_boton11" type="submit" name="button" id="button" value="Por Fecha Enviado" />
          </div></td>
        </form>
        <form id="form6" name="form6" method="post" action="<?php echo $target_link; ?>" target="<?php echo $target_frame; ?>">
          <td><div align="center">
              ...
              <input class="letra_boton11" type="submit" name="button" id="button" value="Por Fecha Descargado" />
          </div></td>
        </form>
      </tr>
      <tr>
...
<div id="apDiv2">
  <table width="100%" border="1" cellpadding="5" cellspacing="0" class="table_width">
    ...
    <tr>
      <td width="43%" class="table_td1">
          <label class="letra_predeterminada">Limitar lista al almacen</label><br />
          <select class="input_predeterminada" name="sel_destino" id="sel_destino">
            <option>Todos</option>
            <option>CEDIS</option>
      ...
      <td width="57%" class="table_td2">
        
        <input type="radio" name="busca" id="radio2" value="pornombre" />
		<label class="letra_predeterminada">Filtrar por texto en Nombre de Archivo:</label><br />
		<input class="input_predeterminada" name="nombre_archivo" type="text" id="nombrearchivo" size="30" maxlength="30" />
        </label>
      </td>
    </tr>
    <tr>
      <td class="table_td1"><span class="table_td11">
        <label class="letra_predeterminada">
        <input type="radio" name="busca" id="radio" value="pororigen" checked="checked" />
Filtrar por  Origen<br />
<select class="input_predeterminada" name="sel_origen" id="select">
  <?php
...
?>
      ...
      <td align="left" class="table_td2"><span class="letra_busc">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td>
              <label class="letra_predeterminada">Usar Rango de fechas </label>
              <label>
              <input name="filtfecha" type="checkbox" class="letra_boton" id="checkbox" />
              </label>
              <label class="letra_predeterminada"> Formato AAAA-MM-DD</label><br />
		  	  <label class="letra_predeterminada">inicio</label>
		      <input class="input_predeterminada" name="fechaesp" type="text" id="fechaesp" size="10" maxlength="10" />
              <label class="letra_predeterminada">Fin</label>
              
              <input class="input_predeterminada" name="textfield" type="text" id="textfield" size="10" maxlength="10" />
