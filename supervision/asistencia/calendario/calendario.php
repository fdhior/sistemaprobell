...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
function escribe_formulario_fecha_vacio($nombrecampo,$nombreformulario,$errorparam, $clase, $estado){
	global $raiz;
	echo "$raiz";	
	echo ' 
	<input'; 
    ...
    echo ' name="'.$nombrecampo.'" size="10" value="'.$errorparam.'"';			
	if ($estado == 'disabled') {
		echo ' disabled="'.$estado.'"';
	}
    echo '>';
	...
	echo ' type=button value="Elige fecha"';
	if ($estado == 'disabled') {
		echo ' disabled="'.$estado.'"';
	}
