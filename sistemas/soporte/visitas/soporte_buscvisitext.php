...
<!-- FORMA DE ENVIO AUTOMATICO POR JAVASCRIPT --><form id="form0" name="form0" action="inicio_administracion_frm2.php" method="post" target="muestra_cambios">
...
<p class="tittextvisitadet">Busqueda en Visitas a Tienda <?php 
			if ($errorpass <> '') {
...
<table class="posbuscoptable" width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    <td width="49%" valign="middle" align="left" scope="col"><form id="form1" name="form1" method="post" action="inicio_validabuscvisitext.php">
    ...
    <td width="51%" align="left" valign="middle" scope="col"><!-- FORMA BUSQUEDA POR TEXTO EN DESC/DETALLE -->
      <form id="form4" name="form1" method="post" action="inicio_validabuscvisitext.php">
  ...
  <tr> 
    <td><!-- FORMA BUSQUEDA POR SUPERVISOR --><form id="form2" name="form1" method="post" action="inicio_validabuscvisitext.php">
...
<?php
    ...
    <td><!-- FORMA BUSQUEDA POR FECHA --><form id="form5" name="form1" method="post" action="inicio_validabuscvisitext.php">
  ...
  <tr> 
    <td><!-- FORMA BUSQUEDA POR TIPO DE VISITA --><form id="form3" name="form1" method="post" action="inicio_validabuscvisitext.php">
...
?>          
    ...
    <td><!-- FORMA BUSQUEDA POR RANGO DE FECHAS --><form id="form9" name="form9" method="post" action="inicio_validabuscvisitext.php">
