...
/*	$fecha_actual = date('Y-m-d');
	...
	$pattern1 = "curs_tecn.nombretec like '%$nombretec%'";
...
?>
        ...
        <td class="pedrcb_td6"><?php echo $row[5];                   ?></td> 
        <!--<td class="pedrcb_td7"><span class="tipoletra">-->
...
//	if ($sel_ttecnico == "activos") {

?>

          <form id="form10<?php echo $i; ?>" name="form10<?php echo $i; ?>" method="post" action="<?php echo $target_link; ?>" target="<?php echo $target_frame; ?>">

            <td class="pedrcb_td7" align="center">
            
            <!--<td align="center">--> <input name="button" type="submit" class="letra_boton11" id="button" value="Editar Tecnico" />
          ...
          <!--<form id="form10<?php echo "$i"; ?>" name="form10<?php echo "$i"; ?>" method="post" action="<?php echo "$hostname$target_link"; ?>" target="<?php echo "$target_frame"; ?>">
            <td align="center"><input class="letra_boton" type="submit" name="button" id="button" value="Eliminar Tecnico" />
              <input name="idtecpass" type="hidden" value="<?php echo "$row[0]"; ?>" />
              <input name="modificar" type="hidden" value="confelmtec" />
              <input name="ntecpass" type="hidden" value="<?php echo "$row[1]"; ?>" /></td>
          </form>-->
