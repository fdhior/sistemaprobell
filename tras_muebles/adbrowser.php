  ...
  <form action="adbrowser.php" method="Post" name="filelist" class="border">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td align="right"><input title="Delete selected files and directories."  type="Submit" onClick="return confirm('&iquest;Estas seguro de querer borrar estos Traslados?');" name="button" value="Borrar Archivos Seleccionados"></td>
      </tr>
    </table>
                Alamacen Actual: Muebles <?php // echo $oBrowser->getCurrentDir($dir); ?><br />
                <br />
...
<!--                                    <label for="selall">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="right"><input title="Delete selected files and directories."  type="Submit" onClick="return confirm('¿Estas seguro de querer borrar estos Traslados?');" name="button" value="Borrar Archivos Seleccionados"></td>
          </tr>
        </table>
