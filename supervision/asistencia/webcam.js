		...
		switch (type) {
			...
			case 'error':
				...
				if (!this.fire_hook('onError', msg)) {
					alert("Error de Camara WEB: Ha ocurrido un error al intentar acceder\nal dispositivo, normalmente esto se debe a que no hay una\ncamara web instalada en el sistema, o no esta conectada,\nverifica las conexiones.\n\nLa verificacion de asistencia ha sido canceladada\n\nEl dispositivo devolvio el siguiente error:\n" + msg);
				}
				setTimeout ("redirecError()", 800);
				break;
