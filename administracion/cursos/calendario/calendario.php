...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
function escribe_formulario_fecha_vacio($nombrecampo,$nombreformulario,$errorparam){
	global $raiz;
	echo "$raiz";	
	echo ' 
	<INPUT name="'.$nombrecampo.'" size="10" value="'.$errorparam.'" >
	<input type=button value="Elige fecha" onclick="muestraCalendario(\''. $raiz.'\',\''. $nombreformulario .'\',\''.$nombrecampo.'\')">
	';	
}
?>