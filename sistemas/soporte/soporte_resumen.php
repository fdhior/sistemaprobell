...
<p><h2> <?php echo $loggeduser; ?>, bienvenido(a) al sistema, mientras no estabas occurri&oacute; lo siguente:<br />
</h2>
</p>
...
/*
	...
	$cols_arr = array("sprt_tcks.idticket", "sprv_prio.prioridad", "inmu_gdat.nombreinmu", "sprt_tcks.asunto", "sprt_tcks.fechahora");
	$num_cols = count($cols_arr);
	$join_tables = '1';
	$tables_arr = array("sprt_tcks", "inmu_gdat", "sprv_prio");
	$num_tables = count($tables_arr);
	$connect = '0';
	$on_fields_arr = array("idinmu", "idprioridad");	
	$where_clause = "sprt_tcks.leido = '0' and sprt_tcks.iduser = '$iduser'";
	$order = "sprt_tcks.fechahora";
	$dir = "DESC";
	$limit = "3";
