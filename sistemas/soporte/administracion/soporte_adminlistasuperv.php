...
/*	echo "Valores de _POST <br />";
	...
	$cols_arr = array("gnrl_usrs.iduser", "gnrl_usrs.username", "gnrl_usrs.nombre", "gnrl_tusr.tipousr", "gnrl_area.area");
...
?>  
	<tr bgcolor="#FFFFFF">
	    ...
	    <th width="9%" scope="col"><span class="tipoletra"><?php echo "$row[4]"; ?></span></th>
        <th width="10%" scope="col"><span class="tipoletra"><a href="inicio_adminsupervdet.php?idv=<?php echo "$row[0]"; ?>" target="muestra_acciones">M&aacute;s Detalles</a></span></th>
  </tr>
<?php
} // Cierre de While
?>
