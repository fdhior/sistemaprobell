...
?>
  <br />
  <span class="letra_predeterminadamargen">No. de Usuarios de Tienda Registrados: <strong><?php echo "$row[0]"; ?></strong></span>
  <?php
...
?>
  <br />
  <span class="letra_predeterminadamargen">No. de Usuarios de Tienda Activos: <strong><?php echo "$row1[0]"; ?></strong></span>
  <?php
...
?>
  <br />
  <span class="letra_predeterminadamargen">No. de Usuarios de Tienda Inhabilitados: <strong><?php echo "$row2[0]"; ?></strong></span>
  <?php
...
?>
  <br />
  <span class="letra_predeterminadamargen">No. de Usuarios de Tienda Eliminados: <strong><?php echo "$row3[0]"; ?></strong></span>
</div>
