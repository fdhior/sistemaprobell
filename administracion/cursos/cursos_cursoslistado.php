...
-->
   ...
   <?php 
        ...
        $target_link   = $hostname.$rel_path.'modificacurso.php';
...
// Se determina que buscar modificando la variable where_clausa
    ...
    // Patr&oacute;n reutilizable de busqueda
        ...
        $pattern1 = "curs_cdet.idcursostat <> 3 AND curs_cdet.idcursostat <> 4 AND fecha > '$fecha_actual'";
        $pattern2 = "curs_cdet.idcursostat = 3 AND fecha > '$fecha_actual'";
        $pattern3 = "curs_cdet.idcursostat <> 3 AND curs_cdet.idcursostat <> 4 AND fecha < '$fecha_actual'";
        $pattern4 = " AND inmu_gdat.idinmu = '$sel_tienda'";
...
?>
       ...
       <tr class="<?php 
        ...
        <td class="pedrcb_td4"><?php echo $row[3]; // Correoe        ?></td>
        <td class="pedrcb_td5"><?php echo "$row[4] $row[5]"; // Status ?></td>
        <td class="pedrcb_td6"><?php echo $row[6];                   ?></td> 
        <td class="pedrcb_td7"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>

<?php

        if ($sel_tcurso == "activos") {

?>

          <form id="form10<?php echo $i; ?>" name="form10<?php echo $i; ?>" method="post" action="<?php echo $target_link; ?>" target="<?php echo $target_frame; ?>">
            <td align="center"><input name="button" type="submit" class="letra_boton11" id="button" value="Modificar Curso" />
              <input name="idcurpass" type="hidden" value="<?php echo $row[0]; ?>" />
              <input name="modificar" type="hidden" value="moddatosform" />
              <input name="ntpass" type="hidden" value="<?php echo $row[1]; ?>" /></td>
          </form>

          <form id="form10<?php echo $i; ?>" name="form10<?php echo $i; ?>" method="post" action="<?php echo $target_link; ?>" target="<?php echo $target_frame; ?>">
            <td align="center"><input class="letra_boton11" type="submit" name="button" id="button" value="Cambiar Estado" />
              <input name="idcurpass" type="hidden" value="<?php echo $row[0]; ?>" />
...
<?php
        ...
        if ($sel_tcurso == "cancelados") {

?>

          <form id="form30<?php echo $i; ?>" name="form30<?php echo $i; ?>" method="post" action="<?php echo $target_link; ?>" target="<?php echo $target_frame; ?>">
            <td align="center"><input class="letra_boton11" type="submit" name="button" id="button" value="Reactivar Curso" />
              <input name="idcurpass" type="hidden" value="<?php echo $row[0]; ?>" />
          ...
          <form id="form30<?php echo $i; ?>" name="form30<?php echo $i; ?>" method="post" action="<?php echo $target_link; ?>" target="<?php echo $target_frame; ?>">
            <td align="center"><input class="letra_boton11" type="submit" name="button" id="button" value="Eliminar Curso" />
              <input name="idcurpass" type="hidden" value="<?php echo $row[0]; ?>" />
