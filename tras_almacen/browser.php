...
if ($_POST['button_top'] == "Eliminar Archivos Seleccionados" or $_POST['button_bottom'] == "Eliminar Archivos Seleccionados") {
...
?>
        <script language="javascript">
                window.alert("<?php echo "".$oBrowser->sError.""; ?>");
        </script>
<?php
}
...
?>
        <script language="javascript">
                window.alert("<?php echo "".$oBrowser->sMessage.""; ?>");
        </script>
<?php
}
?>
...
<div>
  ...
  <br>
          ...
          <tr>
            <td>Archivos Actualmente en el servidor:</td>
            <td align="right"><input title="Delete selected files and directories."  type="Submit" onclick="return confirm('&iquest;Estas seguro de querer borrar los Traslados seleccionados?');" name="button_top" value="Eliminar Archivos Seleccionados"></td>
          </tr>
        </table>
                <br>
<table id="filetable" border="0" cellpadding="0px" cellspacing="1px" width="100%" class="filelisting">
          ...
          <tr>
            <td>&nbsp;</td>
            <td align="right"><input title="Delete selected files and directories."  type="Submit" onclick="return confirm('&iquest;Estas seguro de querer borrar los Traslados seleccionados?');" name="button_bottom" value="Eliminar Archivos Seleccionados"></td>
          </tr>
        </table>
                <br>
