...
<?php
        ...
        /*****************************************************************************/
        /* Administra los pedidos que ya fueron descargados                          */
        /*****************************************************************************/
        ...
        $target_link  = $hostname.$rel_path.'pedidosrcblista.php';
...
<h2><?php echo "$loggeduser $userespname"; ?>,  En esta lista se muestran los Pedidos de tiendas que ya has descargado en tu equipo:</h2>
...
<table class="tblHeaderStd" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="122">Origen</td>
    <td width="130">Recibido el D&iacute;a</td>
    <td width="130">Descargado el D&iacute;a</td>
    <td width="266">Observaciones</td>
    <td width="85">Descargado</td>
    <td width="104">Descargar</td>
  </tr>
</table>
</div>

<iframe class="descdped_frame" align="left" frameborder="0" hspace="0" vspace="0" name="pedlist_frame" scrolling="Yes" src="<?php echo $target_link; ?>" id="pedlist_frame" marginheight="0" marginwidth="0"></iframe>
